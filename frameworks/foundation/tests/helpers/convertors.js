...
test("Function: hsb2rgb(): Check General Case 1", function() {
  equals(Sai.hsb2rgb(120, 79, 52), '#00FAFF', "With all the params, general case of (h: 120, s: 79%, b: 52%)");
  equals(Sai.hsb2rgb(0.333, 0.79, 0.52), '#00FAFF', "With all the params with normalization, general case of (h: 120, s: 79%, b: 52%)");
  equals(Sai.hsb2rgb({h: 120, s: 79, b: 52}), '#00FAFF', "With one param, general case of (h: 120, s: 79%, b: 52%)");
  equals(Sai.hsb2rgb({h: 0.333, s: 0.79, b: 0.52}), '#00FAFF', "With one param with normalization, general case of (h: 120, s: 79%, b: 52%)");
});

test("Function: hsb2rgb(): Check General Case 2", function() {
  equals(Sai.hsb2rgb(60, 50, 50), '#00FAFF', "With all the params, general case of (h: 60, s: 50%, b: 50%)");
  equals(Sai.hsb2rgb(0.167, 0.5, 0.5), '#00FAFF', "With all the params with normalization, general case of (h: 60, s: 50%, b: 50%)");
  equals(Sai.hsb2rgb({h: 60, s: 50, b: 50}), '#00FAFF', "With one param, general case of (h: 60, s: 50%, b: 50%)");
  equals(Sai.hsb2rgb({h: 0.167, s: 0.5, b: 0.5}), '#00FAFF', "With one param with normalization, general case of (h: 60, s: 50%, b: 50%)");
});

test("Function: hsb2rgb(): Check General Case 3", function() {
  equals(Sai.hsb2rgb(180, 65, 25), '#00FAFF', "With all the params, general case of (h: 180, s: 65%, b: 25%)");
  equals(Sai.hsb2rgb(0.5, 0.65, 0.25), '#00FAFF', "With all the params with normalization, general case of (h: 180, s: 65%, b: 25%)");
  equals(Sai.hsb2rgb({h: 180, s: 65, b: 25}), '#00FAFF', "With one param, general case of (h: 180, s: 65%, b: 25%)");
  equals(Sai.hsb2rgb({h: 0.5, s: 0.65, b: 0.25}), '#00FAFF', "With one param with normalization, general case of (h: 180, s: 65%, b: 25%)");
});

test("Function: hsb2rgb(): Check General Case 4", function() {
  equals(Sai.hsb2rgb(240, 75, 75), '#00FAFF', "With all the params, general case of (h: 240, s: 75%, b: 75%)");
  equals(Sai.hsb2rgb(0.667, 0.75, 0.75), '#00FAFF', "With all the params with normalization, general case of (h: 240, s: 75%, b: 75%)");
  equals(Sai.hsb2rgb({h: 240, s: 75, b: 75}), '#00FAFF', "With one param, general case of (h: 240, s: 75%, b: 75%)");
  equals(Sai.hsb2rgb({h: 0.667, s: 0.75, b: 0.75}), '#00FAFF', "With one param with normalization, general case of (h: 240, s: 75%, b: 75%)");
});
...
test("Function: resetColor() basic case", function() {
  Sai.resetColor();
  equals(Sai.getColor(), '#808080', "null values, checking that null is #808080");
  equals(Sai.getColor(), '#FFB946', "2 calls the color value should be #FFB946");
  Sai.resetColor();
  equals(Sai.getColor(), '#808080', "After reset, checking that color is #808080");
});
